...
export default function BrandLeft() {
    return (
        <div className="rounded-[10px] bg-[#FFFFFF] ps-[15px] pe-[14px] pt-[11px] pb-[17px]">
            {/* Banner */}
            <div className="relative overflow-hidden h-[196px] w-full overflow-hidden rounded-[15px]">
                <Image
                    src="/image/brand-product.png"
                    alt="Banner"
                    width={100}
                    height={100}
            ...
            <p className="mt-[15px] mb-[11px] text-[24px] leading-[30px] font-medium text-[#141617]">Kave Home- Hare to See- Kave Home Singapore</p>
            <div className="flex gap-[10px]">
                <button className="border border-[#F1F1F1] gap-[10px] flex items-center justify-center h-[40px] w-[150px] rounded-[10px]"><FaExternalLinkAlt /> kavehome.sg</button>
                <p className="bg-[#00C43717] h-[41px] rounded-[40px] text-[18px] text-[#00C438] leading-5 font-medium px-[15px] py-[10px]">Skin Care</p>
            </div>
            <div className="mt-[15px] mb-5 border-t border-[#00000014]" />
            {/* Top Stats */}
