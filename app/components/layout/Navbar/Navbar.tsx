...
const stats = [
  {
    ...
    imageClassName:
    "w-[60px] h-[60px] min-[1660px]:w-[107px] min-[1660px]:h-[107px]",
    imageTop: "50%",
    imageRight: "-10px",
    badge: "Find LIVEs",
  },
  {
    ...
    boxBg: "linear-gradient(180deg, #48AFFE 0%, #486DFE 100%)",
    imageClassName:
      "w-[80px] h-[90px] min-[1660px]:w-[129px] min-[1660px]:h-[155px]",
    imageTop: "48%",
    imageRight: "-15px",
    badge: "Find Products",
  },
  {
    ...
    boxBg:
      "background: linear-gradient(147.37deg, #F7C11F -8.79%, #F1591D 83.36%);",
    imageClassName:
      "w-[50px] h-[65px] min-[1660px]:w-[88px] min-[1660px]:h-[119px]",
    imageTop: "52%",
    imageRight: "6px",
    badge: "Find Shops",
  },
  {
    ...
    boxBg:
      "background: linear-gradient(147.37deg, #CC95F3 -8.79%, #8B1DF1 83.36%);",
    imageClassName:
      "w-[100px] h-[105px] min-[1660px]:w-[150px] min-[1660px]:h-[169px]",
    imageTop: "50%",
    imageRight: "-35px",
    badge: "Find Creators",
  },
  {
    ...
    boxBg:
      "background: linear-gradient(147.37deg, #F1ED69 -8.79%, #E1AD12 83.36%);",
    imageClassName:
      "w-[110px] h-[110px] min-[1660px]:w-[162px] min-[1660px]:h-[162px]",
    imageTop: "50%",
    imageRight: "-35px",
    badge: "AI Creation",
  },
...
export default function Navbar() {
  return (
    <>
      <div className="rounded-[10px] bg-white py-[9.5px] px-[23px] shadow-sm">
      ...
      <div className="mt-5 grid gap-[15px] min-[1660px]:gap-[25px] sm:grid-cols-5">
        {stats.map((stat) => (
          <NavbarStatItem
            key={stat.label}
